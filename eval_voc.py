...
if __name__ == '__main__':
    ...
    for image_path in tqdm(image_list):
        result = predict_gpu(model,image_path,root_path='/home/user/jusung/tutorial/detection/YOLO/data/VOCdevkit/VOC2007/JPEGImages/') #result[[left_up,right_bottom,class_name,image_path],]
